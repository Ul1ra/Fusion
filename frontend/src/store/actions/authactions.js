export const fetchAndDispatchToken = (dispatch, getState, username, password, email, navigate) => {
  ...
  // const url = 'https://fusion-team-2.propulsion-learn.ch/backend/api/auth/token/';
  const method = 'POST';
...
export const registerEmail = (dispatch, getState, email, navigate) => {
  ...
  // const url = 'https://fusion-team-2.propulsion-learn.ch/backend/api/auth/registration/';
  const method = 'POST';
  const headers = new Headers({'Content-type':'application/json'});
  let body = {email};
  body = JSON.stringify(body);    
...
export const finishRegistration = (dispatch, getState, email, username, password, validation_code, location, password_repeat, navigate) => {
  ...
  // const url = 'https://fusion-team-2.propulsion-learn.ch/backend/api/auth/registration/validation/';
  const method = 'PATCH';
  const headers = new Headers({'Content-type':'application/json'});
